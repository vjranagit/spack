...
sys.path.insert(0, "/home/harmen/spack/lib/spack")
...
def main():
    ...
    print(
        f"{'Spec':<100} | {'Tokens':<7} | {'Tokenize (μs)':<15} | {'Spec() (μs)':<13} | {'Overhead %'}"
    )
    ...
    for spec in TEST_SPECS:
        ...
        print(
            f"{spec_display:<100} | {tokens:<7} | {tokenize_time_us:>15.2f} | {spec_time_us:>13.2f} | {overhead_pct:>10.1f}%"
        )
